...
def markdown_example(request: Request):
    md = MarkdownPage("example")  # We use the MarkdownPage module to pull and compile a Markdown file.
    ...
    # to all templates everywhere. Like the global environment, you can put variables,
    # objects, even functions in the template context.
    #
...
def pages(request: Request):
    ...
    # all of the Markdown we find. That functionality has been implemented
    # in a convenience class called MarkdownCatalog.
    #
    # This sort of object would typically be initialized at the top of the module
    # since every time this route is accessed, the catalog gets re-initialized which
    # is an inefficient use of memory and compute.
    #
    # You can try initializing the catalog at the top of this file and in this method
    # call catalog.load_pages() instead.
